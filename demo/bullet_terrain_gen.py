...
# terr_gen.create_box([0.3, 0.15, 0.00], [0.0, 0, 0 ,-1], '4cm')
# terr_gen.create_box([0.3, -0.15, 0.00], [0.0, 0, 0 ,-1] ,'4cm')

# terr_gen.create_box([0.4, 0.15, 0.00], [0.0, 0, 0 ,-1], '4cm')
# terr_gen.create_box([0.4, -0.15, 0.00], [0.0, 0, 0 ,-1] ,'4cm')

# terr_gen.create_box([0.0, 0.2, 0.0], [0.0, 0, 0 ,-1], '4cm')
# terr_gen.create_box([0.0, -0.2, 0.0], [0.0, 0, 0 ,-1] ,'4cm')

# terr_gen.create_box([0.2, 0.2, 0.00], [0.0, 0, 0 ,-1], '4cm')
# terr_gen.create_box([0.2, -0.2, 0.00], [0.0, 0, 0 ,-1] ,'4cm')
