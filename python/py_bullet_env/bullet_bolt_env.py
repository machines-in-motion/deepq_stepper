...
class BoltBulletEnv:
    ...
    def generate_traj(self, q, dq, fl_foot, fr_foot, n, u_t, t):
        '''
        This function returs the desired location of the foot for the 
        given time step
        '''

        x_des = 2*[0.0, 0.0, -self.ht]
    ...
    def step_env(self, action, des_com, des_vel, x_ori, x_angvel):
        ...
        for t in range(int(self.step_time/self.dt)):
            ...
            x_des, cnt_array = self.generate_traj(q, dq, fl_foot, fr_foot, self.n, u_t, self.dt*t)
            ...
            tau = self.bolt_leg_ctrl.return_joint_torques(q,dq,self.kp,self.kd,x_des, self.xd_des,F)
